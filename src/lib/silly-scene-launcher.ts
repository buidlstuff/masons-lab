...
export const SILLY_SCENE_LAUNCHER_CARDS: SillySceneLauncherCard[] = [
  ...
  { id: 'ice-rink', title: 'Ice Rink', description: 'Everything is frictionless — balls, blocks, and rocks pinball between ramps and walls.', emoji: '⛸️' },
  ...
  { id: 'spring-circus', title: 'Spring Circus', description: 'Three powerful springs launch balls and cargo sky-high in a chaotic juggling act.', emoji: '🎪' },
