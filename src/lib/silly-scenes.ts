...
export const SILLY_SCENES: SillyScene[] = [
  ...
  },
  {
    ...
    createParts: () => [
      ...
      { kind: 'spring-linear', config: { x: 180, y: 320, orientation: 'vertical', restLength: 58, stiffness: 0.08 } },
      { kind: 'spring-linear', config: { x: 480, y: 275, orientation: 'vertical', restLength: 64, stiffness: 0.09 } },
      { kind: 'spring-linear', config: { x: 760, y: 320, orientation: 'vertical', restLength: 58, stiffness: 0.08 } },
